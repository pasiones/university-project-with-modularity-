...
public:
    ...
    /**
     * @brief add_student
     * @param new_student_member
     * Add a student member to course.
     */
    void add_student(Account* new_student_member);

    /**
     * @brief complete_course
     * @param student_member
     * Check if the student has complete the course or not.
     */
    bool complete_course(Account* student_member);
...
private:
    ...
    std::vector<Account*> all_students_;
